...
//
//        ArrayList<LZ77CompressedEntry> compressed = compressor.compressString(stringToCompress, searchWindowLength, lookAheadWindowLength);
//        new CompressionInfo().LZ77Info(stringToCompress, compressed, searchWindowLength, lookAheadWindowLength);
//                
//        io.writeCompressedStringToFile("/resources/text-compressed", compressed);
//        List<LZ77CompressedEntry> reconstructedData = io.compressedStringBasedDataFromFile("/resources/text-compressed");
//
//        String decompressedString = decompressor.decompressString(reconstructedData);
//        System.out.println("Decompressed string: " + decompressedString);
//        
//        byte[] bytesToCompress = io.readBytesFromFile("/resources/text");
//
//        byte[] byteBasedCompressedData = compressor.compressBytes(bytesToCompress, searchWindowLength, lookAheadWindowLength);
//        io.writeBytesToFile("/resources/text-compressedBytes", byteBasedCompressedData);
//        
